...
-- ----------------------------
INSERT INTO `tb_admin_user` VALUES (1, 'admin', '670b14728ad9902aecba32e22fa4f6bd', '南街', 1, 1, NULL);
INSERT INTO `tb_admin_user` VALUES (4, 'yzq', 'e10adc3949ba59abbe56e057f20f883e', 'yzqdev', 0, 1, 'https://i0.hdslb.com/bfs/album/0a75a254e639e7ce606099e1d6c2b75582dc4e8a.jpg');
...
-- ----------------------------
INSERT INTO `tb_blog_category` VALUES (1, 48, 22, '2021-10-29 19:50:39');
INSERT INTO `tb_blog_category` VALUES (28, 51, 22, '2021-10-29 20:59:53');
INSERT INTO `tb_blog_category` VALUES (30, 49, 22, '2021-10-29 21:02:47');
INSERT INTO `tb_blog_category` VALUES (38, 53, 33, '2021-10-30 08:51:04');
INSERT INTO `tb_blog_category` VALUES (39, 52, 33, '2021-10-30 08:58:34');
INSERT INTO `tb_blog_category` VALUES (40, 54, 33, '2021-10-30 08:59:31');
INSERT INTO `tb_blog_category` VALUES (41, 55, 1, '2021-10-30 08:59:39');
INSERT INTO `tb_blog_category` VALUES (45, 56, 33, '2021-10-30 09:21:33');
...
CREATE TABLE `tb_blog_tag`  (
  ...
  PRIMARY KEY (`relation_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 450 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '博客跟标签的关系表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_blog_tag
-- ----------------------------
INSERT INTO `tb_blog_tag` VALUES (451, 48, 1, '2021-10-29 16:39:24');
INSERT INTO `tb_blog_tag` VALUES (454, 51, 1, '2021-10-29 20:59:53');
INSERT INTO `tb_blog_tag` VALUES (456, 49, 1, '2021-10-29 21:02:47');
INSERT INTO `tb_blog_tag` VALUES (468, 54, 1, '2021-10-30 08:59:31');
INSERT INTO `tb_blog_tag` VALUES (469, 55, 1, '2021-10-30 08:59:39');
INSERT INTO `tb_blog_tag` VALUES (478, 56, 1, '2021-10-30 09:21:33');
INSERT INTO `tb_blog_tag` VALUES (479, 56, 152, '2021-10-30 09:21:33');
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评论信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_comment` VALUES (36, 51, '123', '123@11', '', '::: tip\n  在此输入内容\n:::\n:heart_eyes:\n\n- [ ] 任务列表\n', '2021-10-29 21:00:57', '0:0:0:0:0:0:0:1', '', NULL, 1, 0, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36');
...
INSERT INTO `tb_tag` VALUES (152, '333', 0, '2021-10-30 09:05:04');
INSERT INTO `tb_tag` VALUES (154, '444', 0, '2021-10-30 09:06:53');
