...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台管理员信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_admin_user
-- ----------------------------
INSERT INTO `tb_admin_user` VALUES (1, 'admin', '670b14728ad9902aecba32e22fa4f6bd', '南街', 0);
INSERT INTO `tb_admin_user` VALUES (2, 'yzq', 'e10adc3949ba59abbe56e057f20f883e', NULL, 0);
...
CREATE TABLE `tb_blog_comment`  (
  ...
  `reply_create_time` datetime NULL DEFAULT NULL COMMENT '回复时间',
...
-- ----------------------------
INSERT INTO `tb_blog_config` VALUES ('field', 'name', 'value', '2021-08-10 16:59:40', '2021-08-10 16:59:40');
INSERT INTO `tb_blog_config` VALUES ('sysAuthor', '开发者', 'yzq', '2019-08-24 20:33:17', '2021-08-10 14:30:56');
...
INSERT INTO `tb_blog_config` VALUES ('sysEmail', '开发者邮箱', '1826814987@qq.com', '2019-08-24 14:06:48', '2021-08-10 14:30:47');
INSERT INTO `tb_blog_config` VALUES ('sysUpdateTime', '最后修改时间', '2021-08-24 20:33:23', '2019-08-24 20:33:20', '2021-08-10 14:30:39');
...
INSERT INTO `tb_blog_config` VALUES ('websiteName', '博客名', '七月飞雪', '2018-11-11 20:33:01', '2021-08-10 14:30:33');
...
CREATE TABLE `tb_blog_info`  (
  ...
  `blog_category_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 142 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '标签表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_blog_tag` VALUES (140, '表情1', 0, '2021-08-10 14:31:21');
INSERT INTO `tb_blog_tag` VALUES (141, '标签2', 0, '2021-08-10 14:31:38');
...
) ENGINE = InnoDB AUTO_INCREMENT = 333 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '博客跟标签的关系表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_blog_tag_relation
-- ----------------------------
INSERT INTO `tb_blog_tag_relation` VALUES (330, 7, 139, '2019-09-07 11:25:28');
INSERT INTO `tb_blog_tag_relation` VALUES (333, 1, 139, '2021-08-12 00:21:43');
INSERT INTO `tb_blog_tag_relation` VALUES (334, 1, 140, '2021-08-12 00:21:43');
INSERT INTO `tb_blog_tag_relation` VALUES (335, 14, 141, '2021-08-12 00:54:10');
INSERT INTO `tb_blog_tag_relation` VALUES (336, 14, 140, '2021-08-12 00:54:10');
INSERT INTO `tb_blog_tag_relation` VALUES (337, 15, 141, '2021-08-12 00:54:31');
INSERT INTO `tb_blog_tag_relation` VALUES (338, 15, 140, '2021-08-12 00:54:31');
