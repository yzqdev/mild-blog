...
INSERT INTO `tb_blog_category` VALUES (29, 'sff', NULL, 745, 0, '2021-08-25 17:17:51');
INSERT INTO `tb_blog_category` VALUES (32, 'adf', NULL, 1, 0, '2021-08-25 17:38:27');
...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评论信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_blog_comment
-- ----------------------------
INSERT INTO `tb_blog_comment` VALUES (27, 11, 'sdfdsf', 'sfdsf', '', 'saffsff', '2021-08-24 22:44:23', '', '', NULL, 1, 0);
INSERT INTO `tb_blog_comment` VALUES (28, 11, 'sdfdsfsafsf', 'sfdsfsfsdf', '', 'saffsffsfafasf', '2021-08-24 22:44:29', '', '', NULL, 0, 0);
INSERT INTO `tb_blog_comment` VALUES (30, 11, 'aaa', 'aaa', '', '第三方第三方第三方第三方的的', '2021-08-25 15:39:30', '', '', NULL, 1, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '友情链接表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_blog_link
-- ----------------------------
INSERT INTO `tb_blog_link` VALUES (1, 0, '百度', 'https://www.baidu.com', '这是百度', 0, 1, '2021-08-25 20:17:06', '2021-08-25 20:17:06');
INSERT INTO `tb_blog_link` VALUES (2, 0, 'github', 'https://github.com', '这是github', 0, 1, '2019-09-02 21:24:44', NULL);
INSERT INTO `tb_blog_link` VALUES (4, 1, '饿了吗', 'https://element-plus.gitee.io/#/zh-CN/component/link#tu-biao', '222222', 123, 0, '2019-09-03 14:47:21', NULL);
INSERT INTO `tb_blog_link` VALUES (5, 0, 'name', 'field', 'value', 0, 1, '2021-08-25 06:28:56', NULL);
...
-- ----------------------------
INSERT INTO `tb_blog_tag` VALUES (57, 'go语言112', 1, '2018-11-12 00:31:15');
...
INSERT INTO `tb_blog_tag` VALUES (140, 'aaa', 0, '2021-08-24 15:04:32');
INSERT INTO `tb_blog_tag` VALUES (141, 'bbb', 0, '2021-08-24 15:05:14');
...
) ENGINE = InnoDB AUTO_INCREMENT = 393 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '博客跟标签的关系表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_blog_tag_relation` VALUES (392, 35, 139, '2021-08-25 10:45:29');
INSERT INTO `tb_blog_tag_relation` VALUES (393, 35, 140, '2021-08-25 10:45:29');
