...
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."authority_id_seq" CASCADE;
...
CREATE TABLE "public"."authority" (
  "id" int4 NOT NULL DEFAULT nextval('authority_id_seq'::regclass),
...
SELECT setval('"public"."authority_id_seq"', 1, false);
