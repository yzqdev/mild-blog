<template>
  <header class="header">
    ...
    <span class="header-right">
        ...
        <template #dropdown>
          <section class="notice-tab">
            <article class="notice-head">
              ...
              <div class="all-read" @click="readAll">全部已读</div>
            </article>
      ...
      <el-dropdown>
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item>
              <el-link @click="gotoRoute('userInfo')" :underline="false">个人中心</el-link>
            </el-dropdown-item>
            <el-dropdown-item>
    ...
    <el-drawer size="20%" v-model="settingDraw" title="主题配置" direction="rtl">
      <el-row>
        <el-col :span="24">
