        ...
        <el-card shadow="never">
          <template #header
            ><div class="card-header">
              ...
              ></el-button></div
          ></template>
          <div class="analysis"><span>{{boardData.articleCount}}</span></div>
        </el-card>
      </el-col>
      <el-col :span="8">
        <el-card shadow="never">
          ...
          ><div class="card-header" @click="gotoRoute(`commentList`)">
            ...
            <el-button class="button" text>
              ...
              ></el-button></div
          ></template>
          <div class="analysis"><span>{{boardData.commentCount}}</span></div>
        </el-card>
      </el-col>
      <el-col :span="8">
        <el-card shadow="never">
          ...
          ><div class="card-header">
            ...
            <el-button class="button" text>
              ...
              ></el-button></div
          ></template>
          <div class="analysis"><span>{{ boardData.viewsCount }}</span></div>
        </el-card>
      </el-col>
    </el-row>
